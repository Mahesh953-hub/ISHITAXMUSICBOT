    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            LOGGER(__name__).info(
                f"🥀Assɪsᴛᴀɴᴛ Is Wᴏʀᴋɪɴɢ Nᴏᴡ, Nᴀᴍᴇ:- {self.one.name}"
            )
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, f"**┏━━━🔸 Sᴡᴀɢᴀᴛ🔹━━━┓**\n**┃**\n**┃✨ • Assɪsᴛᴀɴᴛ Sᴛᴀʀᴇᴅ ⚡**\n**┃➖➖➖➖➖➖➖➖➖**\n**┃✨ • Iᴅ 🔐 :- {self.one.id}**\n**┃➖➖➖➖➖➖➖➖➖**\n**┃✨ • UsᴇʀNᴀᴍᴇ 🐼 :- @{self.one.username}**\n**┃➖➖➖➖➖➖➖➖➖ **\n**┃✨ • Tʜᴀɴᴋs Fᴏʀ Usɪɴɢ Mᴇ ❤️🌷**\n**┃**\n**┗━━━━━━━━━━━━━━━┛**"
                )
            except:
                LOGGER(__name__).error(
                    f"Wᴇʟʟ, I Dᴏɴᴛ Hᴀᴠᴇ Aᴅᴍɪɴ Rɪɢʜᴛ Iɴ Lᴏɢɢᴇʀ Gʀᴏᴜᴘ"
                )
