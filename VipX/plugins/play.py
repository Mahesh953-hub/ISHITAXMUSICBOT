        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                await mystic.edit_text(
                    "Tʜᴇʀᴇ's Aɴ Eʀʀᴏʀ Iɴ Tʜᴇ Bᴏᴛ, Pʟᴇᴀsᴇ Rᴇᴩᴏʀᴛ Iᴛ Tᴏ Sᴜᴩᴩᴏʀᴛ Cʜᴀᴛ As Sᴏᴏɴ As Pᴏssɪʙʟᴇ."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "Pʟᴇᴀsᴇ Tᴜʀɴ Oɴ VɪᴅᴇᴏCʜᴀᴛ Tᴏ Sᴛʀᴇᴀᴍ Uʀʟ.",
                )
            except Exception as e:
                return await mystic.edit_text(
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "Yᴏᴜ'ʀᴇ Aɴ Aɴᴏɴʏᴍᴏᴜs Aᴅᴍɪɴ\n\nRᴇᴠᴇʀᴛ Bᴀᴄᴋ Tᴏ Usᴇʀ Aᴄᴄᴏᴜɴᴛ Fᴏʀ Usɪɴɢ Mᴇ.",
            show_alert=True,
        )
    except:
        return
