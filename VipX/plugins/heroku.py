...
<u>Usᴀɢᴇ:</u>
Tᴏᴛᴀʟ Usᴇᴅ: `{AppHours}`**H**  `{AppMinutes}`**M**  [`{AppPercentage}`**%**]

<u>Rᴇᴍᴀɪɴɪɴɢ Dʏɴᴏs:</u>
Tᴏᴛᴀʟ Lᴇғᴛ: `{hours}`**H**  `{minutes}`**M**  [`{percentage}`**%**]"""
...
async def update_(client, message, _):
    ...
    if verification == "":
        return await response.edit("**Bᴏᴛ Is Uᴩ-Tᴏ-Dᴀᴛᴇ Wɪᴛʜ Uᴩsᴛʀᴇᴀᴍ Rᴇᴩᴏ !**")
    updates = ""
    ...
    _update_response_ = "<b>**A Nᴇᴡ Uᴩᴅᴀᴛᴇ Is Aᴠᴀɪʟᴀʙʟᴇ Fᴏʀ Tʜᴇ Bᴏᴛ !**</b>\n\n➣ Pᴜsʜɪɴɢ Uᴩᴅᴀᴛᴇs Nᴏᴡ</code>\n\n**<u>Uᴩᴅᴀᴛᴇs:</u>**\n\n"
            ...
            for x in served_chats:
                try:
                    await app.send_message(
                        x,
                        f"** {config.MUSIC_BOT_NAME} Hᴀs Jᴜsᴛ Rᴇsᴛᴀʀᴛᴇᴅ Hᴇʀsᴇʟғ Fᴏʀ Uᴩᴅᴀᴛɪɴɢ Tʜᴇ Bᴏᴛ. Sᴏʀʀʏ Fᴏʀ Tʜᴇ Issᴜᴇs.**\n\n**Yᴏᴜ Cᴀɴ Sᴛᴀʀᴛ Pʟᴀʏɪɴɢ Aɢᴀɪɴ Aғᴛᴇʀ 15-20 Sᴇᴄᴏɴᴅs.**",
                    )
